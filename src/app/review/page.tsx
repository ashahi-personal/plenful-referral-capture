  ...
  return (
    <div className="min-h-screen bg-plenful-gray-50">
      ...
      {isSticky && approvalStatus === "none" && (
        <div className="fixed top-16 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-b border-plenful-gray-200 shadow-sm">
          <div className="max-w-[900px] mx-auto px-6 py-2.5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Link href="/queue" className="p-1 -ml-1 rounded text-plenful-gray-400 hover:text-plenful-teal hover:bg-plenful-teal-light transition-colors" title="Back to queue">
      ...
      <div className="max-w-[900px] mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-3 text-sm mb-6">
          <Link
            href="/queue"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-plenful-teal border border-plenful-teal/20 rounded-lg hover:bg-plenful-teal-light transition-colors"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" /></svg>
            Queue
          </Link>
          <svg className="w-4 h-4 text-plenful-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
          <span className="text-plenful-gray-500">{claim.id}</span>
        </div>
